    ...
    <Layout title={"E-Shop - Home Page "}>
      ...
      <div className="three_divs">
        <div className="del_div">
          ...
          <p>
            For far away, behind the word mountains <br></br>
      ...
      >
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img
              src="../../Carausel/img1.png"
              className="d-block carasol-img  "
              alt="..."
              onClick={() => {
                navigate("/categories");
              }}
      ...
      <section id="summers">
        <div id="summer-appliances">
          <p>Best Deal in Home Appliance</p>
        </div>
        ...
        <div id="appliance">
          <img
            src="../../images/WashingMachines/LG_7_KG_Fully_Auto.jpg"
            alt="logo"
          />
          <div className="app_detail">
            <h4>Washing Mchs</h4>
        ...
        <div className="col-md-3 filters">
          ...
          <div className="d-flex flex-column">
            {categories?.map((c, index) => (
              <Checkbox
                className="categories-created-check"
                key={c._id}
            ...
            <Radio.Group onChange={(e) => setRadio(e.target.value)}>
              {Prices?.map((p, index) => (
                <div className="categories-created-check" key={p._id}>
                  <Radio className="categories-created-check" value={p.array}>{p.name}</Radio>
                </div>
              ))}
            </Radio.Group>
          </div>
        ...
        <div className="col-md-9 all-products-added ">
          ...
          <div className="d-flex flex-wrap">
            {products?.map((p, index) => (
              <div className="card crd m-2" key={p._id}>
                <img
                ...
                <div className="card-body-div">
                  <div className="card-body">
                    ...
                    <div className="card-name-price-btn">
                      <button
      ...
      <section className="container-fluid" id="WhatYouCanBuy">
        ...
        <p>
          ...
          names in the market. What's more, with DesiShop's Complete Mobile
          ...
          replacements - the DesiShop Complete Mobile Protection covers a
        ...
        <p>
          When it comes to laptops, we are not far behind.DesiShop Filter among
          ...
          results in a flash. All you students out there, confused about what
          laptop to get? Our Back To College Store segregates laptops purpose
          wise (gaming, browsing and research, project work, entertainment,
          design, multitasking) with recommendations from top brands and
          industry experts, facilitating a shopping experience that is quicker
          and simpler. Photography lovers, you couldn't land at a better page
          than ours. Cutting-edge DSLR cameras, ever reliable point-and-shoot
        ...
        <p>
          ...
          (Official Brand Warranty along with an extended DesiShop Warranty) -
          ...
          others. For certain product categories, Customers meeting the
          eligibility criteria will have the option to buy larger quantities. To
          know more on the eligibility criteria and terms and conditions, please
          reach out to Purchases.oni@DesiShop.com.
        </p>
        ...
        <h6>Lifestyle</h6>
        <p>
          DesiShop, 'India ka Fashion Capital', is your one-stop fashion
          ...
          get-togethers, weddings, brunches, or nightwear - DesiShop will have
          your back each time.
        </p>
        ...
        <p>
          Launching into the grocery vertical, DesiShop introduces Supermart
